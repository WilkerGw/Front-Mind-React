    ...
    <ThemedView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView>
          ...
          <MaskedTextInput
            mask="(99) 99999-9999"
            onChangeText={setPhone} // O segundo argumento (texto puro) não é necessário aqui
            value={phone}
            style={inputStyle}
          ...
          {/* (Campos da receita não precisam de máscara complexa, mantemos como está) */}
          ...
          <Button title="Salvar Cliente" onPress={handleSave} />
        </ScrollView>
